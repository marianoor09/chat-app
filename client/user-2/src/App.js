...
function App() {
  ...
  const [currentUser, setCurrentUser] = useState({ id: 'user2' });
  ...
  useEffect(() => {
    ...
    socket.on('chat message', (msg) => {
      ...
      const channel = isCurrentUserMessage ? 'channel2' : 'channel1';
    ...
    <div style={chatContainerStyle}>
      <div style={messageContainerStyle}>
        ...
        {combinedMessages.map((msg, index) => {
          const isChannel1 = msg.id === 'channel2';
          const messageStyleToApply = isChannel1 ? messageStyle : messageStyle1;
